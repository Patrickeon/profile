...
export const projectsData = [
    { 
        ...
        year: '2025-2026', 
        company: '페르소나 AI',
        desc: '폐쇄망 환경의 LLM 튜닝 및 RAG 기반 챗봇 시스템 구축',
    ...
    { 
        ...
        year: '2023-2024', 
        company: '(주)갤럭시아머니트리',
        desc: 'STO(토큰증권) 웹 서비스 및 거래 시스템 구축',
    ...
    { 
        ...
        year: '2012-2013', 
        company: '(주)JBL',
        desc: 'PLC 기반 공정 자동화 설비 제어 시스템 개발',
        tech: ['C', 'PLC', 'Windows']
    }
];
